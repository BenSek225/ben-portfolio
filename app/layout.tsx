...
export default function RootLayout({
  ...
  return (
    ...
    <head>
      ...
      <noscript><img height="1" width="1" style={{ display: 'none' } as React.CSSProperties} src="https://www.facebook.com/tr?id=1551174763232392&ev=PageView&noscript=1" /></noscript>
      {/* End Meta Pixel Code */}
    </head>
